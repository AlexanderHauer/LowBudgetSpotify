Command line program that supports user login, with several functions related to music streaming. Note that the program does not support actual mp3 play(yet)
